...
async def cosplay(_,msg):
    ...
    await msg.reply_photo(img, caption=f"❖ ᴄᴏsᴘʟᴀʏ ʙʏ ~○● ɴᴏᴛ | ꜱʜᴇɴɴ •》࿐", reply_markup=InlineKeyboardMarkup(NYKAA),)
...
async def ncosplay(_,msg):
    if msg.chat.type != ChatType.PRIVATE:
      await msg.reply_text("❍ sᴏʀʀʏ ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ᴏɴʟʏ ɪɴ ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ ᴡɪᴛʜ ʙᴏᴛ",
       ...
       await msg.reply_photo(ncosplay, caption=f"❖ ᴄᴏsᴘʟᴀʏ ʙʏ ~○● ɴᴏᴛ | ꜱʜᴇɴɴ •》࿐", reply_markup=InlineKeyboardMarkup(NYKAA),)
