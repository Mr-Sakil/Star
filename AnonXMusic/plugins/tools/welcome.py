...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("AnonXMusic/assets/WELL3.PNG")
    ...
    font = ImageFont.truetype('AnonXMusic/assets/font.ttf', size=45)
...
❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ➥ ○● ɴᴏᴛ | ꜱʜᴇɴɴ •》 ♡゙ ♡゙
▰▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▱▰
""",
reply_markup=InlineKeyboardMarkup(
[
[InlineKeyboardButton(f"ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ", url=f"https://t.me/arthey_Bot?startgroup=new"),
]
]
))
