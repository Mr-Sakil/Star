...
EVAA = [
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ", url=f"https://t.me/DawnChatMusicbot?startgroup=true"),
    ],
]
...
async def _carbon(client, message):
    ...
    await message.reply_photo(carbon, caption=f"❖ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : ○● ɴᴏᴛ | ꜱʜᴇɴɴ •》", reply_markup=InlineKeyboardMarkup(EVAA),
    )
    await text.delete()
    carbon.close()
